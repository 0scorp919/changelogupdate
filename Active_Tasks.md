...
- [ ] **Автоматичний git push `capsule-core` за розкладом**
  - [ ] Розробка `git_sync_manager.py` (інтегрувати з capsule-core)
  - [ ] Перевірка змін перед push (чи не порожній commit)
  - [ ] Обробка помилок мережі/автентифікації
...
- [x] **capsule-core — створення private GitHub репозиторію** (2026-02-27):
  ...
  - SSH налаштований для oleksii-rovnianskyi акаунту
  - Заплановано: git_sync_manager.py для автосинхронізації
